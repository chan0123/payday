module Payday
  ...
  class Invoice
    ...
    attr_accessor :invoice_number, :bill_to, :ship_to, :notes, :line_items, :shipping_rate, :shipping_description,
      :tax_rate, :tax_description, :due_at, :paid_at, :refunded_at, :currency, :invoice_details, :invoice_date, :show_price, :show_total
    ...
    def initialize(options =  {})
      ...
      self.show_price = options[:show_price].nil? ? true : options[:show_price]
      self.show_total = options[:show_total].nil? ? true : options[:show_total]
